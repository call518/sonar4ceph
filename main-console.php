...
echo " <tr>";
echo "  <td align='left'>";
echo "    <b><a href='https://github.com/call518/sonar4ceph' target='_blank'>Sonar4Ceph</a></b>";
echo "  </td>";
echo " </tr>";
echo " <tr>";
echo "  <td>";
...
echo "  </td>";
echo "  <td>";
echo "    <input type=\"button\" value=\"Dump-Info - Pool/OSD/PG\" style=\"width:90%\" onclick=\"window.open('dump-info.php?req_info_type=POOL', 'Dump-Info - Pool/OSD/PG', 'width=1024, height=800')\">";
echo "  </td>";
echo " </tr>";
echo "</table>";
...
echo "  </td>";
echo "  <td>";
echo "   <input type=\"button\" style=\"width:90%\" value=\"OSD Latency - Commit (ms)\" onclick=\"window.open('osd-latency-commit.php', 'OSD Latency - Commit (ms)', 'width=1024, height=800')\">";
echo "  </td>";
echo " </tr>";
echo "</table>";
...
echo " <tr>";
echo "  <td align='left'>";
echo "    <b><a href='https://github.com/A-Dechorgnat/inkscope-lite' target='_blank'>Inkscope-Lite</a></b>";
echo "  </td>";
echo " </tr>";
echo " <tr>";
echo "  <td>";
